...
class BirdImagesController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $validated = $request->validate([
            ...
            'link_image' => 'required|image', // También asegúrate de que el campo 'link_image' sea requerido y sea una imagen
        ]);
     ...
     */
    public function destroy(BirdImage $birdImage) // Corregir aquí
    {
        //
    }
}
